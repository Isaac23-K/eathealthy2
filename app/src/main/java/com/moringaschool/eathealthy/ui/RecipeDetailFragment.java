...
public class RecipeDetailFragment extends Fragment {
    ...
    @BindView(R.id.fragmentImageView)
    ImageView hereImage;
    @BindView(R.id.fragmentNameTextView)
    TextView fragmentName;
    @BindView(R.id.ingredientsTextView)
    TextView ingredientViews;
    @BindView(R.id.labelTextView)
    TextView labelIngredient;
    @BindView(R.id.ingredientsTextView2)
    TextView ingredientViews2;
    @BindView(R.id.ingredientsTextView3)
    TextView ingredientView3;
